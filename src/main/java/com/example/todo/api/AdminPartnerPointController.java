...
@RestController
public class AdminPartnerPointController implements AdminPartnerPointsApi {

    private static final List<TodoDemoPointManagementPointSummaryResponse> MOCK_LIST = List.of(
        mockSummary(1L, "김철수", "대리", 8_000L, TodoDemoPointManagementWalletStatus.ACTIVE),
        mockSummary(2L, "이영희", "과장", 15_000L, TodoDemoPointManagementWalletStatus.ACTIVE),
        mockSummary(3L, "박민준", "사원", 0L, TodoDemoPointManagementWalletStatus.FROZEN)
    );

    @Override
    public ResponseEntity<TodoDemoPointManagementPointSummaryPage> adminPartnerPointsApiList(
    ...
    @Override
    public ResponseEntity<TodoDemoPointManagementPointDetailResponse> adminPartnerPointsApiGet(Long employeeInfoId) {
        ...
        detail.setPartnerId(null);
        detail.setPartnerName(null);
    ...
    @Override
    public ResponseEntity<TodoDemoPointManagementPointTransactionPage> adminPartnerPointsApiListTransactions(
            Long employeeInfoId, Integer page, Integer size, TodoDemoPointManagementPointTransactionType type) {
        throw new UnsupportedOperationException("구현 필요");
    }

    @Override
    public ResponseEntity<TodoDemoPointManagementPointTransactionResponse> adminPartnerPointsApiCreateTransaction(
    ...
    private static TodoDemoPointManagementPointSummaryResponse mockSummary(
            Long id, String name, String position, Long balance, TodoDemoPointManagementWalletStatus status) {
